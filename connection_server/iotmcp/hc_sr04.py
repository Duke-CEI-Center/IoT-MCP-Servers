...
mcp = FastMCP(
    "HC-SR04",
    description="HC-SR04 PC data monitoring via MCP. Supports distance reading."
)
...
async def read_distance(
    ...
    Returns:
    A distance measurement with timestamp, or list of measurements if Real_time is True.
    """
    cmd = {"sensor": "HC-SR04", "command": "read_distance", "interval": interval, "duration": duration}
